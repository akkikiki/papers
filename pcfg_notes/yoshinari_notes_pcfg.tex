...
In conlcusion, the main problem under Bayesian framework using Dirichlet prior with hyper-parameter $\alpha$ is to compute the posterior $P(\boldsymbol{t}, \theta | \boldsymbol{s}, \alpha)$.
